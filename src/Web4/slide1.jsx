...
export default function Slide1web4() {
  return (
    ...
    >
      ...
      <h1 className="text-center text-4xl md:text-6xl lg:text-7xl mt-8 md:ml-[18%] font-extrabold font-scienceGothic tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-200 via-pink-200 to-yellow-200">
        Web 3.0 vs. Web 4.0
      </h1>
      ...
      <img
        ...
        alt="web evolution"
        className="md:ml-[18%] w-64 md:w-96 rounded-3xl border-2 shadow-sm shadow-white"
      />
    </div>
  );
}
