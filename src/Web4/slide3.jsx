...
export default function Slide3web4() {
  return (
    ...
    >
      ...
      <h1 className="hidden md:block absolute left-[-12%] rotate-[-90deg] text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-200 via-green-300 to-yellow-200">
      ...
      <p className="mt-4 text-center text-xl md:ml-[18%] text-indigo-100/90 max-w-xl mb-4">
        AI moves from being an application feature (like a chatbot) to the
        underlying logic.
      </p>
      <p className="mt-4 text-center text-md md:ml-[18%] text-indigo-100/90 max-w-xl mb-4">
        Self-directed AI programs capable of complex, multi-step operations
        across different platforms without continuous human input.
      </p>
      <img
        src="https://cdn.mos.cms.futurecdn.net/VFLt5vHV7aCoLrLGjP9Qwm-970-80.jpg.webp"
        alt="web evolution"
        width={380}
        className="md:ml-[18%] rounded-3xl border-2 shadow-sm shadow-white"
      />
    </div>
  );
}
