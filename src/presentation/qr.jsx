...
export default function QR() {
  return (
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="g1-qr" x1="0" x2="1">
      ...
      <h1 className="hidden md:block absolute left-0 rotate-[-90deg] ml-10 text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-200 via-green-300 to-yellow-200">
        QR CODE
      </h1>
      <h1 className="text-3xl font-bold mb-6 md:ml-[18%]">Scan the QR Code</h1>
      <img src={QRCodeImage} alt="QR Code" className="w-64 h-64 md:ml-[18%]" />
    </div>
  );
}
