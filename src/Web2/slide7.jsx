  ...
  return (
    ...
    >
      ...
      <div className="w-full md:max-w-4xl mx-auto mt-10 z-20">
        <h1 className="mb-10 text-center text-xl md:text-4xl lg:text-5xl md:pl-10 md:ml-[23%] font-extrabold font-scienceGothic tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-200 via-pink-200 to-yellow-200">
          Popular examples of Web 2.0 Applications
        </h1>
        <div className="flex flex-col md:flex-row md:justify-between items-center gap-10 md:ml-44 md:gap-10">
          <div className="flex flex-col items-center md:block">
            <img
              className="hidden md:block h-44 pl-10 mb-16"
              src={Arrowleft}
              alt="arrow"
            />
            <img
              className="h-32 md:h-44 animate-bounce border-solid border-purple-400 border-4 rounded-md"
              src={Facebook}
              alt="facebook"
            />
            <p className="mt-4 text-center text-xl md:ml-[22%] bg-clip-text text-transparent bg-gradient-to-r from-green-200 via-green-300 to-yellow-200 max-w-xl mb-4">
              {" "}
              Facebook{" "}
            </p>
          </div>
          <div className="flex flex-col items-center md:block">
            <img
              className="hidden md:block h-44 pl-10 mb-16 rotate-[90deg]"
              src={Arrow}
              alt="arrow"
            />
            <img
              className="h-32 md:h-44 md:pl-8 animate-bounce border-solid border-purple-400 border-4 rounded-md"
              src={Linkedin}
              alt="linkedin"
            />
            <p className="mt-4 text-center text-xl md:ml-[22%] bg-clip-text text-transparent bg-gradient-to-r from-green-200 via-green-300 to-yellow-200 max-w-xl mb-4">
          ...
          <div className="flex flex-col items-center md:block">
            <img
              className="hidden md:block h-44 mb-16 rotate-[90deg]"
              src={Arrowright}
              alt="arrow"
            />
            <img
              className="h-32 md:h-44 md:pl-10 animate-bounce border-solid border-purple-400 border-4 rounded-md"
              src={Steam}
              alt="steam"
            />
            <p className="mt-4 text-center text-xl md:ml-[22%] bg-clip-text text-transparent bg-gradient-to-r from-green-200 via-green-300 to-yellow-200 max-w-xl mb-4 ">
