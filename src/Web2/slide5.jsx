...
export default function Fifthslide() {
  return (
    ...
    >
      ...
      <p className="mt-4 text-center text-xl md:text-3xl md:ml-[22%] text-indigo-100/90 max-w-2xl mb-4">
        <span className="hidden md:inline text-blue-400 pr-4 text-3xl relative  animate-pulse drop-shadow-[0_0_10px_rgba(0, 0, 255, 0.7)]">
          🌟
        </span>
