    ...
    <div
        ...
        >
          ...
          <div className="  hidden  md:block absolute -left-48 rotate-[-90deg] text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-200 via-green-300 to-yellow-200">
             <h1 className="pl-28">Advantages and </h1> <h1> Disadvantages of Web 2.0</h1>
          </div>
          ...
          <p className="mt-4 text-center text-2xl md:text-3xl md:ml-[22%] text-indigo-100/90 max-w-2xl mb-4">
          
            <span className="text-blue-400 pr-4 text-3xl relative  animate-pulse drop-shadow-[0_0_10px_rgba(0, 0, 255, 0.7)]">🌟</span>
            
              Spread of misinformation and unreliable content.
          </p>
          <p className="mt-4 text-center text-2xl md:text-3xl md:ml-[22%] text-indigo-100/90 max-w-2xl mb-4">
          
            <span className="text-blue-400 pr-4 text-3xl relative  animate-pulse drop-shadow-[0_0_10px_rgba(0, 0, 255, 0.7)]">🌟</span>
            
              Privacy and cybersecurity risks (e.g., identity theft, cyberbullying).
          </p>
          <p className="mt-4 text-center text-2xl md:text-3xl md:ml-[22%] text-indigo-100/90 max-w-2xl mb-4">
          
            <span className="text-blue-400 pr-4 text-3xl relative  animate-pulse drop-shadow-[0_0_10px_rgba(0, 0, 255, 0.7)]">🌟</span>
            
              Potential for online scams, fake accounts, and spamming.
          </p>
