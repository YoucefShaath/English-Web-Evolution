  ...
  return (
    <div
        ...
        >
          ...
          <h1 className=" mb-10 pl-10 text-center text-5xl md:text-6xl lg:text-7xl  md:ml-[23%] font-extrabold font-scienceGothic tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-200 via-pink-200 to-yellow-200">
            Comparaison
          </h1>

  <div className=" ml-56 overflow-hidden rounded-2xl shadow-2xl backdrop-blur-sm bg-white/10 border border-white/20">
    <table className="w-full text-left text-white">
      <thead className="bg-white/10">
        <tr>
          <th className="px-6 py-4 text-2xl font-semibold">Feature</th>
          <th className="px-6 py-4 text-2xl font-semibold">Web 1.0</th>
          <th className="px-6 py-4 text-2xl font-semibold">Web 2.0</th>
        </tr>
      </thead>
      ...
      <tbody className="divide-y divide-white/10">
        ...
        <tr className="hover:bg-white/5 transition">
          <td className="px-6 py-4 ">Information</td>
          <td className="px-6 py-4">Static</td>
          <td className="px-6 py-4">Dynamic</td>
        </tr>

        <tr className="hover:bg-white/5 transition">
          <td className="px-6 py-4">User Input</td>
          <td className="px-6 py-4">Controlled</td>
          <td className="px-6 py-4">Open / Less controlled</td>
        </tr>
        ...
        <tr className="hover:bg-white/5 transition">
          <td className="px-6 py-4">Interaction</td>
        ...
        <tr className="hover:bg-white/5 transition">
          ...
          <td className="px-6 py-4">Informative</td>
          <td className="px-6 py-4">Social and Interactive</td>
        </tr>
