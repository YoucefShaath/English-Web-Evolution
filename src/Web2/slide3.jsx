  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-4xl mx-auto mt-10 z-20">
        <h1 className="text-center text-2xl md:text-4xl lg:text-5xl md:ml-[36%] font-extrabold font-scienceGothic tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-200 via-pink-200 to-yellow-200">
          Wikis
        </h1>
        <p className="mt-2 md:mt-4 text-center text-lg md:text-xl md:ml-[36%] text-indigo-100/90 max-w-xl mx-auto md:mr-0 mb-6 md:mb-4">
        ...
        <p className="mt-2 md:mt-4 text-center text-lg md:text-xl md:ml-[36%] text-indigo-100/90 max-w-xl mx-auto md:mr-0 mb-6 md:mb-4">
          Platforms for interaction and content sharing (e.g., Facebook,
          Instagram, X).
        </p>
        <h1 className="text-center text-2xl md:text-4xl lg:text-5xl md:ml-[36%] font-extrabold font-scienceGothic tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-200 via-pink-200 to-yellow-200">
        ...
        <p className="mt-2 md:mt-4 text-center text-lg md:text-xl md:ml-[36%] text-indigo-100/90 max-w-xl mx-auto md:mr-0 mb-6 md:mb-4">
          Multimedia sharing, blogs, and self-publishing platforms (e.g.,
          Medium, Substack).
        </p>
      </div>
    </div>
