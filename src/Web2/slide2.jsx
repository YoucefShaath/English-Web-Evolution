    ...
    <div
        ...
        >
          ...
          >
            ...
            <span className="text-pink-400 drop-shadow-[0_0_10px_rgba(255,0,128,0.7)]">❤️</span>
            </div>
            <div className="absolute bottom-40 left-96 text-6xl animate-pulse">
            <span className="text-pink-400 drop-shadow-[0_0_10px_rgba(255,0,128,0.7)]">❤️</span>
            </div>
            <div className="absolute bottom-40 right-20 text-6xl animate-pulse">
            <span className="text-blue-400 drop-shadow-[0_0_10px_rgba(0, 0, 255, 0.7)]">👍</span>
            </div>
            <div className="absolute top-40 left-96 text-6xl animate-pulse">
            <span className="text-blue-400 drop-shadow-[0_0_10px_rgba(0, 0, 255, 0.7)]">👍</span>
            </div>
          ...
          <p className="mt-4 text-center text-xl md:ml-[22%] text-indigo-100/90 max-w-xl mb-4">
            Is The second stage of internet evolution, focusing on interactivity and user-generated content.
          </p>
          ...
          <p className="mt-4 text-center text-2xl md:text-3xl md:ml-[22%] text-indigo-100/90 max-w-xl mb-4">
            ...
            Enables social media, collaborative tools, wikis, and knowledge-sharing platforms.
          </p>
        </div>
      );
    }
