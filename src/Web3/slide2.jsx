...
export default function Slide2Web3() {
  return (
    <div
    ...
    >
      ...
      <p className="mt-4 text-center text-xl md:ml-[18%] text-indigo-100/90 max-w-xl mb-4">
        Web 3.0 relies on structured data to connect information meaningfully across the web.
        Using standards like schema.org and linked data, content becomes machine-readable,
        enabling smarter search, recommendations, and AI-driven applications.
      </p>
    </div>
  );
}
