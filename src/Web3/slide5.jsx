...
export default function Slide5Web3() {
  return (
    <div
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="g1-s5" x1="0" x2="1">
      ...
      <p className="mt-4 text-center text-xl md:ml-[18%] text-indigo-100/90 max-w-xl mb-4">
        Web3 applications, or dApps, run on decentralized networks, giving users control
        over data and interactions. Unlike centralized apps, dApps are transparent,
        peer-to-peer, and resistant to single points of failure.
      </p>
    </div>
  );
}
