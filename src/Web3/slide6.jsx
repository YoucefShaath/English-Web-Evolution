...
export default function Slide6Web3() {
  return (
    <div
    ...
    >
      ...
      <p className="mt-4 text-center text-xl md:ml-[18%] text-indigo-100/90 max-w-xl mb-4">
        Web 3.0 envisions a “read–write–own” internet where users control their data,
        digital assets, and identity. By combining semantic intelligence and decentralization,
        it empowers individuals and transforms online interactions.
      </p>

      <p className="mt-2 text-center text-lg md:ml-[18%] text-indigo-100/80 max-w-xl mb-4">
        Users participate in governance, own content, and collaborate in a more
        transparent, secure, and intelligent web ecosystem.
      </p>
    </div>
  );
}
